                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><button class="dropdown-item" type="button"><small>Latest (5.2.3)</small></button></li>
                                    <li><button class="dropdown-item" type="button"><small>Latest (5.1.3)</small></button></li>
                                    <li><button class="dropdown-item" type="button"><small>Latest (5.0.2)</small></button></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><h6 class="dropdown-header">Previous release</h6></li>
                                    <li><button class="dropdown-item" type="button"><small>Latest (4.6.x)</small></button></li>
                                    <li><button class="dropdown-item" type="button"><small>Latest (3.4.1)</small></button></li>
                                    <li><button class="dropdown-item" type="button"><small>Latest (2.3.2)</small></button></li>
                                    <li><hr class="dropdown-divider"></li>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-md-7 order-md-1">
                    ...
                    <p class="fs-5 mt-3">Quickly design and customize responsive mobile-first
            ...
            <div class="row">
                <div class= "col-lg-6">
                    ...
                    <p class="fs-5">Take Bootstrap to the next level with premium themes from the
                        <a href="#">official Bootstrap Themes marketplace</a>. Themes are built on Bootstrap as their own extended frameworks, rich with new components and plugins, documentation, and powerful build tools. </p>
                    <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#"> Browse Bootstrap Themes
                        <i class="bi bi-arrow-right mb-2"></i>
                    </a>
                </div>
                <div class= "col-lg-6">
            ...
            <div class= "row">
                <div class="col-lg-3 mb-5">
                    ...
                    <div class="mt-2 text-muted">
                        <small>Designed and built with all the love in the world by the
                            <a href="#" class="text-black">Bootstrap team</a> with the help of
                            <a href="#" class="text-black">our contributors</a>.</small>
                    </div>
                    <div class="mt-2 text-muted">
                        <small>Code licensed
                            <a href="#" class="text-black">MIT</a>, docs
                ...
                <div class="col-6 col-lg-2 mb-5">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="#">Starter template</a></li> <li class="mb-2"><a href="#">Webpack</a></li>
...
<?php /**PATH D:\----- 1. Kuliah\2. Bahan - bahan Kuliah\✨ SEMESTER 4\PEMROGRAMAN FRAMEWORK - IS-04-04\Pertemuan 4\Laravel Project\modul-3\resources\views/clone.blade.php ENDPATH**/ ?>